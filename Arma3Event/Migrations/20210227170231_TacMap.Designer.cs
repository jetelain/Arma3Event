...
namespace Arma3Event.Migrations
{
    ...
    [Migration("20210227170231_TacMap")]
    partial class TacMap
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Arma3Event.Entities.ContentBlock", b =>
                {
            ...
            modelBuilder.Entity("Arma3Event.Entities.Document", b =>
                {
            ...
            modelBuilder.Entity("Arma3Event.Entities.News", b =>
                {
            ...
            modelBuilder.Entity("Arma3Event.Entities.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("Arma3Event.Entities.Video", b =>
                {
            ...
            modelBuilder.Entity("Arma3Event.Entities.MapMarker", b =>
                {
                    ...
                    b.Navigation("RoundSide");

                    b.Navigation("RoundSquad");
                });
            ...
            modelBuilder.Entity("Arma3Event.Entities.UserLogin", b =>
                {
                    b.HasOne("Arma3Event.Entities.User", "User")
                        .WithOne("ManualLogin")
                        .HasForeignKey("Arma3Event.Entities.UserLogin", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Arma3Event.Entities.Match", b =>
                {
                    ...
                    b.Navigation("MatchTechnicalInfos");
