...
namespace Arma3Event.Controllers
{
    ...
    public class AdminGameMapsController : Controller
    {
        ...
        public AdminGameMapsController(Arma3EventContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(GameMap gameMap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, GameMap gameMap)
        {
